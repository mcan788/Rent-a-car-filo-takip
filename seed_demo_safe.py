...
def get_direct_session():
    engine = create_engine('mssql+pyodbc:///?odbc_connect=DRIVER={ODBC Driver 17 for SQL Server};SERVER=localhost\\SQLEXPRESS;DATABASE=RENT_A_CAR_DEMO_DB;Trusted_Connection=yes;Encrypt=no;TrustServerCertificate=yes')
...
def clear_data():
    ...
    if True:
        tenant_session = get_direct_session()
